    ...
    <section className="relative py-40 px-6 md:px-12 lg:px-24">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <span className="text-zinc-400 text-sm">Тарифы и планы</span>
        ...
        <p className="text-zinc-400 text-lg max-w-md mb-16">
          <span className="text-white font-medium">Начните бесплатно.</span> Пробный период без ограничений — никаких кредитных карт. Выберите план, который подходит именно вам.
        </p>
          ...
          >
            ...
            <div className="relative h-[400px]">
              ...
              >
                ...
                <span className="text-zinc-300 text-sm font-medium">NightCore Free — базовая защита</span>
                <div
              ...
              >
                ...
                <span className="text-zinc-500 text-sm">NightCore Pro</span>
              </div>
              ...
              >
                <span className="text-zinc-400 text-sm">NightCore Business</span>
              ...
              >
                <span className="text-zinc-400 text-sm">Electron Desktop</span>
                <div className="flex gap-0.5">
                  <div className="w-2.5 h-2.5 rotate-45 bg-zinc-500/60" />
                  <div className="w-2.5 h-2.5 rotate-45 bg-zinc-500/60" />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="border-t border-r border-b border-zinc-800 pt-10 pr-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">NightCore Pro — всё включено</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Безлимитный трафик, 50+ серверов, поддержка 5 устройств и приоритетная поддержка.
            </p>

            <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-5">
              <h4 className="text-lg font-medium text-zinc-200 mb-5">Что входит в Pro</h4>

              {/* Properties row */}
              <div className="flex items-center gap-4 mb-4">
                <span className="text-zinc-500 text-sm w-24">Тариф</span>
                <div className="flex items-center gap-2">
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-violet-900/50 text-violet-300 text-xs">
              ...
              {/* Devices row */}
              <div className="flex items-center gap-4 mb-4">
                <span className="text-zinc-500 text-sm w-24">Устройства</span>
                <div className="flex items-center gap-2">
                  <span className="flex items-center gap-1.5 px-2 py-1 rounded bg-zinc-800 text-zinc-300 text-xs">
                    <span className="text-blue-400">до 5 одновременно</span>
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <span className="text-zinc-500 text-sm w-24 pt-1">Включено</span>
                <div className="flex flex-col gap-2">
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-violet-500" />
                    AES-256 шифрование <span className="text-zinc-500">✓</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-300 text-sm">
                    <span className="w-2.5 h-2.5 rotate-45 bg-violet-500" />
                    Kill Switch <span className="text-zinc-500">✓</span>
                  </span>
                  <span className="flex items-center gap-2 text-zinc-400 text-sm">
                    ...
                    Split Tunneling <span className="text-zinc-500">✓</span>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-b border-zinc-800 pt-10 pl-10 pb-16">
            <h3 className="text-xl font-medium text-zinc-200 mb-3">Статус подключения</h3>
            <p className="text-zinc-500 text-base leading-relaxed mb-8">
              Мониторинг скорости и стабильности в реальном времени — прямо в приложении.
            </p>
            ...
            <div className="relative h-48">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-green-500 font-medium text-sm">Защищено</span>
                </div>
                <p className="text-zinc-300 text-sm mb-3">Германия — Франкфурт · 12ms · 450 Мбит/с</p>
                <span className="text-zinc-500 text-xs">NightCore VPN активен</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="border-r border-zinc-800 pt-16 pr-10 pb-16 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-zinc-200 font-medium">No-logs политика</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-violet-500/50" />
                <span className="text-zinc-400">DNS leak protection</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-1 h-5 rounded-full bg-violet-500/30" />
                <span className="text-zinc-500">WebRTC блокировка</span>
              </div>
            </div>
          </div>
